...
// in this context the "this" is the Student object joe

// 2. What is "this" when joe.scopeArrow() is invoked?
// in this context the "this" is the Window object

// 3. Explain why "this" is different when an arrow function is used.
// Arrow functions don't have their own bindings to `this`, `arguments` or `super`, and should not be used as methods, and therefore Arrow functions cannot be used as constructors.
